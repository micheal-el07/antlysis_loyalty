...
const ROW_GRID = "grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)_120px_140px] items-center gap-x-6";
...
export default function AdminVouchersTable({ vouchers, loadStatus, error, onRetry, emptyState }) {
