...
const ROW_GRID =
  "grid grid-cols-[140px_minmax(0,1fr)_120px_100px_120px_40px] items-center gap-x-6";
...
export default function AdminReceiptsTable({ receipts, loadStatus, error, onRetry, emptyState }) {
